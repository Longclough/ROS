...
#include <routescalculationextension/navfn_planner.h>
...
#include <routescalculationextension/navfn.h>
//#include "nav2_util/costmap.hpp"
//#include "nav2_util/node_utils.hpp"
#include <routescalculationextension/cost_values.h>
  ...
  std::shared_ptr<nav2_costmap_2d::Costmap2D> costmap)
{
  ...
  planner_ = std::unique_ptr<NavFn>(new NavFn(
    ...
    if (getPlanFromPotential(best_pose, plan)) {
      ...
      if (use_final_approach_orientation_) {
        ...
        if (plan_size == 1) {
          ...
          theta = atan2(dy, dx);
          plan.poses.back().pose.orientation = {0,0,0,0};
