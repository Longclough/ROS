    ...
    extends AbstractAIXMObjectType
{
    ...
    @XmlElementRef(name = "requiredClearance", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValDistanceType> requiredClearance;
    @XmlElementRef(name = "minimumAltitude", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValDistanceVerticalType> minimumAltitude;
    @XmlElementRef(name = "surfacePenetration", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeYesNoType> surfacePenetration;
    @XmlElementRef(name = "slopePenetration", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValAngleType> slopePenetration;
    @XmlElementRef(name = "controlling", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeYesNoType> controlling;
    @XmlElementRef(name = "closeIn", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeYesNoType> closeIn;
    @XmlElementRef(name = "theVerticalStructure", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
