    ...
    extends AbstractAIXMObjectType
{
    ...
    @XmlElementRef(name = "designGradient", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValSlopeType> designGradient;
    @XmlElementRef(name = "terminationAltitude", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValDistanceVerticalType> terminationAltitude;
    @XmlElementRef(name = "turnPermitted", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
