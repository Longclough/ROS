    ...
    extends AbstractAIXMObjectType
{
    ...
    @XmlElementRef(name = "referenceLocation", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeYesNoType> referenceLocation;
    @XmlElementRef(name = "relationWithLocation", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
