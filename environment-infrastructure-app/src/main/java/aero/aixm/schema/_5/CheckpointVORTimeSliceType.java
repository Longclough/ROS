...
/**
 * <p>Java class for CheckpointVORTimeSliceType complex type.
 * 
    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @XmlElementRef(name = "checkPointFacility", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    ...
    public List<CheckpointVORTimeSliceType.Extension> getExtension() {
        if (extension == null) {
            extension = new ArrayList<CheckpointVORTimeSliceType.Extension>();
        }
