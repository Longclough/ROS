    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @XmlElementRef(name = "taxiwayLocation", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<TaxiwayPropertyType> taxiwayLocation;
    @XmlElementRef(name = "standLocation", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
