    ...
    extends AbstractSegmentPointType
{
    ...
    @XmlElementRef(name = "sequence", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<NoSequenceType> sequence;
    @XmlElementRef(name = "usageType", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
