    ...
    extends AbstractAIXMObjectType
{
    ...
    @XmlElementRef(name = "maximumLimit", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValDistanceVerticalType> maximumLimit;
    @XmlElementRef(name = "maximumLimitReference", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "minimumLimit", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValDistanceVerticalType> minimumLimit;
    @XmlElementRef(name = "minimumLimitReference", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "horizontalProjection", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<SurfacePropertyType> horizontalProjection;
    @XmlElementRef(name = "centreline", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CurvePropertyType> centreline;
    @XmlElementRef(name = "contributorAirspace", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
