    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "oxygenSupply", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
        @XmlElementRef(name = "availability", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
        @XmlElementRef(name = "oilSupply", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
        ...
        @XmlElementRef(name = "fuelSupply", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
        ...
        @XmlElementRef(name = "nitrogenSupply", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
