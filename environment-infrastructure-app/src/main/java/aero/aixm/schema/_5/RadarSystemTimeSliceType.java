    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @XmlElementRef(name = "model", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<TextNameType> model;
    @XmlElementRef(name = "generalTerrainMonitor", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeYesNoType> generalTerrainMonitor;
    @XmlElementRef(name = "broadcastIdentifier", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
