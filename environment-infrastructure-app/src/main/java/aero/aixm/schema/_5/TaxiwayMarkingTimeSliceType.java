    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @XmlElementRef(name = "markedTaxiway", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<TaxiwayPropertyType> markedTaxiway;
    @XmlElementRef(name = "markedElement", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
