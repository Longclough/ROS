    ...
    extends AbstractAIXMObjectType
{
    ...
    @XmlElementRef(name = "alternateClimbInstruction", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<TextInstructionType> alternateClimbInstruction;
    @XmlElementRef(name = "alternateClimbAltitude", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
