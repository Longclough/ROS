    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @XmlElementRef(name = "thresholdAfterMAPT", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeYesNoType> thresholdAfterMAPT;
    @XmlElementRef(name = "heightMAPT", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
