    ...
    extends AbstractAIXMObjectType
{
    ...
    @XmlElementRef(name = "altitudeAdjustmentType", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeAltitudeAdjustmentType> altitudeAdjustmentType;
    @XmlElementRef(name = "primaryAlternateMinimum", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeYesNoType> primaryAlternateMinimum;
    @XmlElementRef(name = "altitudeAdjustment", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValDistanceVerticalType> altitudeAdjustment;
    @XmlElementRef(name = "localRemoteCode", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
