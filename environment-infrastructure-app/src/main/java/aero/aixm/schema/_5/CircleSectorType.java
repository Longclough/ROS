    ...
    extends AbstractAIXMObjectType
{
    ...
    @XmlElementRef(name = "arcDirection", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeArcDirectionType> arcDirection;
    @XmlElementRef(name = "fromAngle", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValBearingType> fromAngle;
    @XmlElementRef(name = "toAngle", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "angleDirectionReference", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeDirectionReferenceType> angleDirectionReference;
    @XmlElementRef(name = "innerDistance", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValDistanceType> innerDistance;
    @XmlElementRef(name = "outerDistance", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
