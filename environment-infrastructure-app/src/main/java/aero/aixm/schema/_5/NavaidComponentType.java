    ...
    extends AbstractAIXMObjectType
{
    ...
    @XmlElementRef(name = "collocationGroup", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<NoSequenceType> collocationGroup;
    @XmlElementRef(name = "markerPosition", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodePositionInILSType> markerPosition;
    @XmlElementRef(name = "providesNavigableLocation", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
