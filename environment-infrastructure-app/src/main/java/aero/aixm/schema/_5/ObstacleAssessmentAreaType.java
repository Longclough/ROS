    ...
    extends AbstractAIXMObjectType
{
    ...
    @XmlElementRef(name = "sectionNumber", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "assessedAltitude", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValDistanceVerticalType> assessedAltitude;
    @XmlElementRef(name = "slopeLowerAltitude", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValDistanceVerticalType> slopeLowerAltitude;
    @XmlElementRef(name = "gradientLowHigh", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValSlopeType> gradientLowHigh;
    @XmlElementRef(name = "surfaceZone", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeObstructionIdSurfaceZoneType> surfaceZone;
    @XmlElementRef(name = "safetyRegulation", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "startingCurve", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
