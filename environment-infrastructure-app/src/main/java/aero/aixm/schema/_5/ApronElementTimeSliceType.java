    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @XmlElementRef(name = "jetwayAvailability", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeYesNoType> jetwayAvailability;
    @XmlElementRef(name = "towingAvailability", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeYesNoType> towingAvailability;
    @XmlElementRef(name = "dockingAvailability", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeYesNoType> dockingAvailability;
    @XmlElementRef(name = "groundPowerAvailability", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "associatedApron", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
