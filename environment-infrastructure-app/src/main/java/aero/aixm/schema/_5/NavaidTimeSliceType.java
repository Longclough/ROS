    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "touchDownLiftOff", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
        @XmlElementRef(name = "name", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
        @XmlElementRef(name = "integrityLevel", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
        @XmlElementRef(name = "courseQuality", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
        @XmlElementRef(name = "servedAirport", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
        ...
        @XmlElementRef(name = "purpose", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
        @XmlElementRef(name = "navaidEquipment", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
        @XmlElementRef(name = "signalPerformance", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
     ...
     * line 13210 of file:/C:/AIXM/AIXM_Features.xsd
