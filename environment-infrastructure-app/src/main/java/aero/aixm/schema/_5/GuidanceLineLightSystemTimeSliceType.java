...
/**
 * <p>Java class for GuidanceLineLightSystemTimeSliceType complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;group ref="{http://www.aixm.aero/schema/5.1}GuidanceLineLightSystemPropertyGroup"/>
    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @XmlElementRef(name = "lightedGuidanceLine", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    ...
    public List<GuidanceLineLightSystemTimeSliceType.Extension> getExtension() {
        if (extension == null) {
            extension = new ArrayList<GuidanceLineLightSystemTimeSliceType.Extension>();
        }
