    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @XmlElementRef(name = "patternVFR", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeDirectionTurnType> patternVFR;
    @XmlElementRef(name = "slopeTDZ", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValSlopeType> slopeTDZ;
    @XmlElementRef(name = "elevationTDZ", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValDistanceVerticalType> elevationTDZ;
    @XmlElementRef(name = "elevationTDZAccuracy", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValDistanceType> elevationTDZAccuracy;
    @XmlElementRef(name = "approachMarkingType", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeRunwayMarkingType> approachMarkingType;
    @XmlElementRef(name = "approachMarkingCondition", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeMarkingConditionType> approachMarkingCondition;
    @XmlElementRef(name = "classLightingJAR", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeLightingJARType> classLightingJAR;
    @XmlElementRef(name = "precisionApproachGuidance", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeApproachGuidanceType> precisionApproachGuidance;
    @XmlElementRef(name = "usedRunway", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<RunwayPropertyType> usedRunway;
    @XmlElementRef(name = "startingElement", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
