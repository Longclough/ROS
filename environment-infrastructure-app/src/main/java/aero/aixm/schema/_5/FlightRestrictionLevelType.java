    ...
    extends AbstractAIXMObjectType
{
    ...
    @XmlElementRef(name = "upperLevel", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValDistanceVerticalType> upperLevel;
    @XmlElementRef(name = "upperLevelReference", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeVerticalReferenceType> upperLevelReference;
    @XmlElementRef(name = "lowerLevel", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValDistanceVerticalType> lowerLevel;
    @XmlElementRef(name = "lowerLevelReference", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
