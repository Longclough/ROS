...
/**
 * <p>Java class for FlightConditionCombinationType complex type.
 * 
 ...
 *         &lt;group ref="{http://www.aixm.aero/schema/5.1}FlightConditionCombinationPropertyGroup"/>
    ...
    extends AbstractPropertiesWithScheduleType
{
    ...
    public List<FlightConditionElementPropertyType> getElement() {
        if (element == null) {
            element = new ArrayList<FlightConditionElementPropertyType>();
        }
        return this.element;
    }
    ...
    public List<FlightConditionCombinationType.Extension> getExtension() {
        if (extension == null) {
            extension = new ArrayList<FlightConditionCombinationType.Extension>();
        }
