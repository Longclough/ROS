    ...
    extends AbstractAIXMObjectType
{
    ...
    @XmlElementRef(name = "flightConditions", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "visibilityInterpretation", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeValueInterpretationType> visibilityInterpretation;
    @XmlElementRef(name = "runwayVisualRange", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValDistanceType> runwayVisualRange;
    @XmlElementRef(name = "runwayVisualRangeInterpretation", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
