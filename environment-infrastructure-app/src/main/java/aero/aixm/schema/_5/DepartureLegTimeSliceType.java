...
/**
 * <p>Java class for DepartureLegTimeSliceType complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;group ref="{http://www.aixm.aero/schema/5.1}DepartureLegPropertyGroup"/>
    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @XmlElementRef(name = "minimumObstacleClearanceAltitude", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValDistanceVerticalType> minimumObstacleClearanceAltitude;
    @XmlElementRef(name = "departure", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    ...
    public List<DepartureArrivalConditionPropertyType> getCondition() {
        if (condition == null) {
            condition = new ArrayList<DepartureArrivalConditionPropertyType>();
        }
    ...
    public List<DepartureLegTimeSliceType.Extension> getExtension() {
        if (extension == null) {
            extension = new ArrayList<DepartureLegTimeSliceType.Extension>();
        }
