 ...
 *         &lt;group ref="{http://www.aixm.aero/schema/5.1}PostalAddressPropertyGroup"/>
    ...
    extends AbstractPropertiesWithScheduleType
{
    ...
    @XmlElementRef(name = "deliveryPoint", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<TextAddressType> deliveryPoint;
    @XmlElementRef(name = "city", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<TextNameType> city;
    @XmlElementRef(name = "administrativeArea", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<TextNameType> administrativeArea;
    @XmlElementRef(name = "postalCode", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<TextNameType> postalCode;
    @XmlElementRef(name = "country", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
