    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @XmlElementRef(name = "nonStandardHolding", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeYesNoType> nonStandardHolding;
    @XmlElementRef(name = "outboundLegSpan_endTime", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<HoldingPatternDurationPropertyType> outboundLegSpanEndTime;
    @XmlElementRef(name = "outboundLegSpan_endDistance", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<HoldingPatternDistancePropertyType> outboundLegSpanEndDistance;
    @XmlElementRef(name = "outboundLegSpan_endPoint", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
