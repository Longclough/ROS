    ...
    extends AbstractPropertiesWithScheduleType
{
    ...
    @XmlElementRef(name = "network", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeTelecomNetworkType> network;
    @XmlElementRef(name = "linkage", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<TextAddressType> linkage;
    @XmlElementRef(name = "protocol", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<TextNameType> protocol;
    @XmlElementRef(name = "eMail", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
