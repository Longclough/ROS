    ...
    extends AbstractPropertiesWithScheduleType
{
    ...
    @XmlElementRef(name = "verticalExtent", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValDistanceType> verticalExtent;
    @XmlElementRef(name = "verticalExtentAccuracy", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "constructionStatus", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeStatusConstructionType> constructionStatus;
    @XmlElementRef(name = "markingPattern", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeVerticalStructureMarkingType> markingPattern;
    @XmlElementRef(name = "markingFirstColour", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeColourType> markingFirstColour;
    @XmlElementRef(name = "markingSecondColour", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "frangible", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeYesNoType> frangible;
    @XmlElementRef(name = "visibleMaterial", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "horizontalProjection_location", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ElevatedPointPropertyType> horizontalProjectionLocation;
    @XmlElementRef(name = "horizontalProjection_linearExtent", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ElevatedCurvePropertyType> horizontalProjectionLinearExtent;
    @XmlElementRef(name = "horizontalProjection_surfaceExtent", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
