    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "clientAerialRefuelling", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
        @XmlElementRef(name = "clientHolding", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
        @XmlElementRef(name = "annotation", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
        @XmlElementRef(name = "dataLinkChannel", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
        @XmlElementRef(name = "clientProcedure", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
        @XmlElementRef(name = "call-sign", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
        @XmlElementRef(name = "clientAirport", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
        @XmlElementRef(name = "radarAssisted", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
        ...
        @XmlElementRef(name = "dataLinkEnabled", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
        @XmlElementRef(name = "clientAirspace", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
        ...
        @XmlElementRef(name = "clientRoute", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
        @XmlElementRef(name = "aircraftLocator", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
