    ...
    extends AbstractAIXMObjectType
{
    ...
    @XmlElementRef(name = "timeReference", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeTimeReferenceType> timeReference;
    @XmlElementRef(name = "startDate", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<DateMonthDayType> startDate;
    @XmlElementRef(name = "endDate", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<DateMonthDayType> endDate;
    @XmlElementRef(name = "day", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeDayType> day;
    @XmlElementRef(name = "dayTil", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeDayType> dayTil;
    @XmlElementRef(name = "startTime", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<TimeType> startTime;
    @XmlElementRef(name = "startEvent", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeTimeEventType> startEvent;
    @XmlElementRef(name = "startTimeRelativeEvent", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValDurationType> startTimeRelativeEvent;
    @XmlElementRef(name = "startEventInterpretation", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeTimeEventCombinationType> startEventInterpretation;
    @XmlElementRef(name = "endTime", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<TimeType> endTime;
    @XmlElementRef(name = "endEvent", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeTimeEventType> endEvent;
    @XmlElementRef(name = "endTimeRelativeEvent", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValDurationType> endTimeRelativeEvent;
    @XmlElementRef(name = "endEventInterpretation", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeTimeEventCombinationType> endEventInterpretation;
    @XmlElementRef(name = "daylightSavingAdjust", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeYesNoType> daylightSavingAdjust;
    @XmlElementRef(name = "excluded", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
