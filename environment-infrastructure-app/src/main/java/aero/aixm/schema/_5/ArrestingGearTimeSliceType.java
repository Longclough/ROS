    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @XmlElementRef(name = "engageDevice", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeArrestingGearEngageDeviceType> engageDevice;
    @XmlElementRef(name = "absorbType", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeArrestingGearEnergyAbsorbType> absorbType;
    @XmlElementRef(name = "bidirectional", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "extent_curveExtent", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ElevatedCurvePropertyType> extentCurveExtent;
    @XmlElementRef(name = "extent_surfaceExtent", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ElevatedSurfacePropertyType> extentSurfaceExtent;
    @XmlElementRef(name = "extent_pointExtent", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
