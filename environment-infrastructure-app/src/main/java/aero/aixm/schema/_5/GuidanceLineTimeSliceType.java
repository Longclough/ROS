    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @XmlElementRef(name = "maxSpeed", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValSpeedType> maxSpeed;
    @XmlElementRef(name = "usageDirection", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
