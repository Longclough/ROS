    ...
    extends AbstractSegmentPointType
{
    ...
    @XmlElementRef(name = "leadRadial", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValBearingType> leadRadial;
    @XmlElementRef(name = "leadDME", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValDistanceType> leadDME;
    @XmlElementRef(name = "indicatorFACF", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
