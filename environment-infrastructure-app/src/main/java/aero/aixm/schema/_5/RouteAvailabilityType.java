...
/**
 * <p>Java class for RouteAvailabilityType complex type.
 * 
 ...
 *         &lt;group ref="{http://www.aixm.aero/schema/5.1}RouteAvailabilityPropertyGroup"/>
    ...
    extends AbstractPropertiesWithScheduleType
{
    ...
    @XmlElementRef(name = "direction", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeDirectionType> direction;
    @XmlElementRef(name = "cardinalDirection", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link RouteAvailabilityType.Extension }
     * 
     * 
     */
    public List<RouteAvailabilityType.Extension> getExtension() {
        if (extension == null) {
            extension = new ArrayList<RouteAvailabilityType.Extension>();
        }
