    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @XmlElementRef(name = "hostAirport", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<AirportHeliportPropertyType> hostAirport;
    @XmlElementRef(name = "dependentAirport", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
