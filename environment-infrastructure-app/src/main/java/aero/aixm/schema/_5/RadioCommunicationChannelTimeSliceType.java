    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @XmlElementRef(name = "mode", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "frequencyTransmission", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValFrequencyType> frequencyTransmission;
    @XmlElementRef(name = "frequencyReception", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "logon", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<TextDesignatorType> logon;
    @XmlElementRef(name = "emissionType", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeRadioEmissionType> emissionType;
    @XmlElementRef(name = "selectiveCall", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "trafficDirection", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
