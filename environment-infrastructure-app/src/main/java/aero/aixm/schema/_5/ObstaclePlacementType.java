    ...
    extends AbstractAIXMObjectType
{
    ...
    @XmlElementRef(name = "obstacleBearing", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValBearingType> obstacleBearing;
    @XmlElementRef(name = "obstacleDistance", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValDistanceType> obstacleDistance;
    @XmlElementRef(name = "pointType", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<TextNameType> pointType;
    @XmlElementRef(name = "obstaclePlacement", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
