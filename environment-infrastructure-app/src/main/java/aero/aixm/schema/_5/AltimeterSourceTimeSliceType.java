    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @XmlElementRef(name = "isRemote", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeYesNoType> isRemote;
    @XmlElementRef(name = "isPrimary", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
