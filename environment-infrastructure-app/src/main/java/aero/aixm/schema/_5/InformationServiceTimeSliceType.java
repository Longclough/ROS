    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "voice", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
        ...
        @XmlElementRef(name = "navaidBroadcast", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
        ...
        @XmlElementRef(name = "dataLink", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
        @XmlElementRef(name = "clientHolding", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
        @XmlElementRef(name = "recorded", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
