    ...
    extends AbstractSurfaceContaminationType
{
    ...
    @XmlElementRef(name = "clearedLength", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValDistanceType> clearedLength;
    @XmlElementRef(name = "clearedWidth", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValDistanceType> clearedWidth;
    @XmlElementRef(name = "clearedSide", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeSideType> clearedSide;
    @XmlElementRef(name = "furtherClearanceLength", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValDistanceType> furtherClearanceLength;
    @XmlElementRef(name = "furtherClearanceWidth", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValDistanceType> furtherClearanceWidth;
    @XmlElementRef(name = "obscuredLightsSide", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeSideType> obscuredLightsSide;
    @XmlElementRef(name = "clearedLengthBegin", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValDistanceType> clearedLengthBegin;
    @XmlElementRef(name = "taxiwayAvailable", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeYesNoType> taxiwayAvailable;
    @XmlElementRef(name = "apronAvailable", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
