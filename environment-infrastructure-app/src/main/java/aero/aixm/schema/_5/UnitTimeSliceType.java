    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "airportLocation", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
        @XmlElementRef(name = "availability", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
        @XmlElementRef(name = "ownerOrganisation", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
        @XmlElementRef(name = "military", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
        ...
        @XmlElementRef(name = "relatedUnit", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class),
     ...
     * line 14924 of file:/C:/AIXM/AIXM_Features.xsd
