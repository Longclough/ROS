    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @XmlElementRef(name = "angleScallop", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ValAngleType> angleScallop;
    @XmlElementRef(name = "signalType", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeRadioSignalType> signalType;
    @XmlElementRef(name = "equipment_navaidEquipment", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<NavaidEquipmentPropertyType> equipmentNavaidEquipment;
    @XmlElementRef(name = "equipment_frequency", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<RadioCommunicationChannelPropertyType> equipmentFrequency;
    @XmlElementRef(name = "equipment_specialNavigationStation", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<SpecialNavigationStationPropertyType> equipmentSpecialNavigationStation;
    @XmlElementRef(name = "equipment_precisionApproachRadar", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<PrecisionApproachRadarPropertyType> equipmentPrecisionApproachRadar;
    @XmlElementRef(name = "equipment_radar", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
