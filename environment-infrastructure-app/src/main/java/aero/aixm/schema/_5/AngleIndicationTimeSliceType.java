    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @XmlElementRef(name = "indicationDirection", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<CodeDirectionReferenceType> indicationDirection;
    @XmlElementRef(name = "trueAngle", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
