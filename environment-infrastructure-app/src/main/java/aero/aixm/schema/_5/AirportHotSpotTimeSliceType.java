 ...
 *       &lt;sequence>
 *         &lt;group ref="{http://www.aixm.aero/schema/5.1}AirportHotSpotPropertyGroup"/>
    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @XmlElementRef(name = "area", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
    protected JAXBElement<ElevatedSurfacePropertyType> area;
    @XmlElementRef(name = "affectedAirport", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class)
