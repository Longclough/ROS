 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.opengis.net/gml/3.2}parameterValue_GL" maxOccurs="unbounded" minOccurs="2"/>
    ...
    extends AbstractGeneralParameterValueType
{
    ...
    @XmlElementRef(name = "parameterValue_GL", namespace = "http://www.opengis.net/gml/3.2", type = JAXBElement.class)
    protected List<JAXBElement<AbstractGeneralParameterValuePropertyType>> parameterValueGL;
    ...
    /**
     * Gets the value of the parameterValueGL property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the parameterValueGL property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getParameterValueGL().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<JAXBElement<AbstractGeneralParameterValuePropertyType>> getParameterValueGL() {
        if (parameterValueGL == null) {
            parameterValueGL = new ArrayList<JAXBElement<AbstractGeneralParameterValuePropertyType>>();
        }
        return this.parameterValueGL;
    }
