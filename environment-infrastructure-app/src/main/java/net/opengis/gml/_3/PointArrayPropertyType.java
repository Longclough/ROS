...
public class PointArrayPropertyType {
    ...
    protected List<JAXBElement<? extends net.opengis.gml._3.PointType>> point;
     ...
     * 
     */
    public List<JAXBElement<? extends net.opengis.gml._3.PointType>> getPoint() {
        if (point == null) {
            point = new ArrayList<JAXBElement<? extends net.opengis.gml._3.PointType>>();
        }
        return this.point;
    }
